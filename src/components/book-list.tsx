...
const StyledBottomSheetFlatList = createBox<Theme, FlatListProps<Book>>(BottomSheetFlatList)
...
const BookList: React.FC<Props> = ({
    ...
    const ListComponent = inBottomSheet ? StyledBottomSheetFlatList : StyledFlatList
